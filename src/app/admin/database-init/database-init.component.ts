...
import { testDatabaseConnection, addSampleData, initializeDatabase } from '../../test-database';
...
export class DatabaseInitComponent {
  ...
  async testConnection() {
    ...
    try {
      ...
      this.addLog(result ? 'Database connection successful!' : 'Database connection failed!', 
  ...
  async addSampleDataToDb() {
    ...
    try {
      ...
      this.addLog(result ? 'Sample data added successfully!' : 'Failed to add sample data!', 
                  result ? 'success' : 'error');
    } catch (error) {
  ...
  async initializeFullDatabase() {
    ...
    try {
      ...
      this.addLog('Database initialization completed!', 'success');
    } catch (error) {
      this.connectionStatus = 'failed';
